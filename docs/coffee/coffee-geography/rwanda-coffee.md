...
- Coffee introduced by German colonists in early 1900s
- Expanded under Belgian rule in 1930s
- Primarily low-quality commodity production

**Post-Genocide Transformation (1994-Present)**:
- 1994 genocide devastated coffee sector
- PEARL program launched in 2000 shifted focus to quality
- Investment in washing stations and training
- Women's cooperatives empowered
- Today: Rwanda is a specialty coffee success story
...
**Red Bourbon** (95%+ of production):
- High cup quality, sweet and clean
- Lower yields than modern varieties
- Well-adapted to Rwandan terroir

**Other varieties**: Jackson (Bourbon mutation), limited Caturra

See: Coffee Varieties MOC, [Bourbon Variety](../coffee-varieties/bourbon-variety.md)

## Processing

Almost exclusively **washed** process:
1. Selective picking (ripe cherries only)
2. Floatation sorting
3. Pulping and fermentation (12-24 hours)
4. Washing in channels
5. Drying on African raised beds (12-18 days)

**Coffee Washing Stations (CWS)** are central to quality:
- Serve multiple smallholders
- Professional management
- Quality control and traceability
- Many cooperatively owned
...
- More approachable than [Kenya Coffee](kenya-coffee.md)
- Cleaner than Ethiopian Coffee/Ethiopia Coffee Articles/Ethiopia and Coffee
- Very similar to Burundi Coffee

## Quality & Grading

**Screen size grades**:
- **A1** (17+): Premium
- **A2** (15-16): Standard specialty
- **A3** (14): Lower price point
...
- Bourbon variety
- Recent harvest (6-12 months)
- Cup score 84+
- Cooperative name for traceability
...
**Best methods**: Pour over, Aeropress, drip
**Roast level**: Light to light-medium (showcases brightness)
**Ratio**: 1:15-1:17
...
- [Kenya Coffee](kenya-coffee.md) - Regional comparison
- [Bourbon Variety](../coffee-varieties/bourbon-variety.md)
- ../Washed Process
- Women in Coffee
- Direct Trade Coffee
...
**Best For**: Clean, approachable East African coffee; social impact stories
**Signature**: Sweet, balanced, stone fruit
**Brewing**: Light-medium roast, pour over, 1:16 ratio, 200°F
