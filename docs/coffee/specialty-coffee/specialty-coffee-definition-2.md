...
Coffee must score **80 points or above** on the SCA cupping protocol to qualify as specialty grade.
...
Beyond the score, specialty coffee must also be:
...
Coffee is evaluated on 10 attributes, each scored individually:
...
The 10 attribute scores are totalled, then cupper points (defects subtracted, bonuses added) are applied to reach final score out of 100.
...
**The Reality:**
Specialty green coffee can become non-specialty coffee through:
...
**Quality Philosophy:**
Specialty coffee represents commitment to:
...
**Specialty Coffee Identity:**
Beyond just scoring 80+, specialty coffee should be traceable to:
...
**Pricing Structure:**
Specialty coffee operates on **quality-based pricing**, not commodity pricing:
...
Should specialty coffee also require:
...
**The Promise:**
When a café claims "specialty coffee":
...
**The Risk:**
"Specialty" used as marketing without standards undermines the definition. Cafés should be able to prove their coffee meets specialty criteria.
...
**The Question:**
Does specialty coffee help or harm environment?
...
**The Reality:**
Specialty coffee alone doesn't guarantee sustainability. Additional commitments and certifications needed.
...
- Specialty Coffee Movement MOC - Broader movement context
- [SCA Cupping Protocol](../coffee-tasting/sca-cupping-protocol.md) - How quality is measured
- [Q Grader Certification](../coffee-tasting/q-grader-certification.md) - Professional evaluation
- Coffee Grading Systems - Physical standards
- [Quality Control MOC](../maps-of-content/quality-control-moc.md) - Maintaining standards
- [Green Coffee Quality](../green-coffee-beans/green-coffee-quality.md) - Pre-roast assessment
- [Cup of Excellence](../coffee-business/cup-of-excellence.md) - Competition and quality showcase
- [Direct Trade](direct-trade.md) - Relationship economics
- Coffee Pricing Models - Quality-based value

---

*Part of All-About-Coffee.com - The comprehensive coffee knowledge vault*

**See also**: Specialty vs Commercial Coffee | [Quality Standards](quality-standards.md) | Coffee Evaluation
