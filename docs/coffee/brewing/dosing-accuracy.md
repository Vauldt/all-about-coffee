...
Dosing accuracy is the ability to consistently deliver the same weight of ground coffee for each shot of espresso or brew. It's one of the most fundamental barista skills and the foundation of consistent extraction. Without accurate dosing, every other variable becomes meaningless—you're building on unstable ground.

## Why Dosing Accuracy Matters

**The Critical Relationship:**
Dose affects everything:
...
**The Mathematics:**
If your recipe is 18g in, 36g out:
...
**The Reality:**
You cannot control extraction if you cannot control dose. Accurate dosing is non-negotiable for quality coffee.
...
**Sensory Threshold:**
Most trained palates can detect differences of 0.5g or more in espresso. Variations beyond 1g are obvious to almost anyone. Below 0.3g, differences become difficult to perceive consistently.

**Practical Limits:**
Even with excellent technique, factors like static, humidity, and grinder retention create some natural variation. ±0.2g is realistically achievable; ±0.1g requires exceptional conditions and equipment.
...
Some modern grinders dose by weight rather than time:
...
**The Challenge:**
Different baristas, different technique, variable results
...
- [Distribution Techniques](../coffee-brewing-espresso/distribution-techniques.md) - What happens after dosing
- ../Tamping Fundamentals - Preparing the puck
- ../Extraction Fundamentals - How dose affects extraction
- 05_PUBLISHING/Dictionary/Dictionary Atomic Notes/Brew Ratio - Dose as part of recipe
- Grind Size Impact - Interaction with dose
- Barista/Barista Skills /Barista Skills Development MOC - Skill progression framework
- ../Espresso Dialling - Using dose in recipe development
- ../Equipment Calibration - Ensuring accuracy

---

*Part of All-About-Coffee.com - The comprehensive coffee knowledge vault*

**See also**: Consistency Protocols | ../Quality Control MOC | Technical Skills Training
