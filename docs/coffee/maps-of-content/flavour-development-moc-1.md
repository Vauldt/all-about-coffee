...
- [Anaerobic fermentation](../coffee-processing/anaerobic-fermentation.md) - Oxygen-free flavor development
...
- [Strecker Degradation](../coffee-roasting/strecker-degradation.md) - Amino acid breakdown and flavors
- [Pyrolysis](../coffee-roasting/pyrolysis.md) - High-heat chemical decomposition
- [First Crack](../roasting-coffee-beans/first-crack.md) - Physical and chemical changes
...
- [Charge Temperature](../coffee-roasting/charge-temperature.md) - Starting conditions
- [Rate of Rise](../coffee-roasting/rate-of-rise.md) - Heat application patterns
- [Development Time Ratio](../coffee-roasting/development-time-ratio.md) - Post-crack development
- Airflow and Flavor - Heat transfer and smoke management
- Batch Size - Consistency and heat penetration

**Roasting by Process**

- [Roasting Washed Coffee](../coffee-roasting/roasting-washed-coffee.md) - Preserving clarity
- [Roasting Natural Coffee](../coffee-roasting/roasting-natural-coffee.md) - Managing fruit-forward profiles
- Roasting Honey Process - Balancing sweetness and complexity
...
- [Extraction](../brewing-fundamentals/extraction.md) - What dissolves and when
- [Extraction Yield](../brewing-fundamentals/extraction-yield.md) - How much flavor makes it to the cup
...
- [Contact Time](../coffee-brewing/contact-time.md) - Duration and extraction progression
...
- [Volatile Compounds](../coffee-roasting/volatile-compounds.md) - Aromatic flavor molecules
- Phenolic Compounds - Bitterness and astringency

### Specific Flavor Compounds

- [Chlorogenic Acids](../tasting-coffee/chlorogenic-acids.md) - Brightness and bitterness
...
- [Cupping Protocol](../coffee-tasting/cupping-protocol.md) - Standardized tasting method
...
- [Coffee Freshness](../coffee-roasting/coffee-freshness.md) - Days off roast
...
- [Channeling](../brewing-fundamentals/channeling.md) - Uneven extraction
- [Astringency](../tasting-coffee/astringency.md) - Over-extraction or tannins
...
- [Fermentation Control](../coffee-processing/fermentation-control.md) - Monitoring and consistency
...
- [Sample Roasting](../coffee-roasting/sample-roasting.md) - Testing and planning
...
- [Equipment Maintenance](../coffee-equipment/equipment-maintenance.md) - Cleanliness and calibration
...
**Beginner**: Start with The Flavor Wheel, practice [Cupping Protocol](../coffee-tasting/cupping-protocol.md), learn to identify [Acidity](../tasting-coffee/acidity.md), 05_PUBLISHING/Dictionary/Dictionary Atomic Notes/Body, and ../Sweetness. Understand how Roast Level affects flavor.

**Intermediate**: Study ../Maillard Reaction and Caramelization, learn ../Processing Methods impact, practice Blind Tasting, understand [Extraction](../brewing-fundamentals/extraction.md) basics and troubleshooting.

**Advanced**: Master Flavor Chemistry, study Sensory Calibration, understand interactions between all variables, learn Quality Control and [Defect Identification](../coffee-green-beans/defect-identification.md), develop Flavor Memory and reference standards.
...
- [Coffee Chemistry MOC](coffee-chemistry-moc.md) - Molecular basis of flavor
- [Coffee Origin MOC](../coffee-origin-moc.md) - Terroir and regional characteristics
