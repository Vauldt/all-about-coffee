---
title: "Origin-Specific_Standards"
tags: [coffee/green-beans]
status: Draft
aliases: []
related: []
---
...
**Colonial Legacy:**
Many grading systems date to colonial era:
...
**Local Adaptation:**
Post-independence, countries maintained or modified systems:
...
**Geographic Reality:**
Different growing conditions require different approaches:
...
**Market Positioning:**
Countries developed standards to:
...
1. Depulp cherry
2. Ferment briefly (overnight)
3. Wash off mucilage
4. Dry in parchment to ~30-35% moisture (semi-dry)
5. Hull parchment while still wet
6. Dry naked beans to 12%
...
**Origin-specific standards:**
1. **Vary significantly** - No two countries identical
2. **Reflect history** - Colonial legacy and local evolution
3. **Impact pricing** - Different systems, different values
4. **Require learning** - Each origin needs study
5. **Are evolving** - Cup quality increasingly universal
...
- [Green Coffee Grading](../green-coffee-beans/green-coffee-grading.md) - How grading works
- ../../Specialty Coffee Definition - The 80-point standard
- [Coffee Origins MOC](../maps-of-content/coffee-origins-moc.md) - Geographic diversity
...
- [Direct Trade](../specialty-coffee/direct-trade.md) - Bypassing traditional systems
...
**See also**: Coffee Production MOC | [Coffee Economics](../coffee-business/coffee-economics.md) | Sourcing Coffee
